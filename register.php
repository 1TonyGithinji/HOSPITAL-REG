...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <h1 style="color: red;text-align: center;">Doctor Registration</h1>
      <form method="post" action="register.php" style="text-align: center;font-size: 25px">
  	   ...
  	   <p><b>Already a member? <a href="login.php">Sign in</a></b></p><br>
  </form>
</body>
</html>